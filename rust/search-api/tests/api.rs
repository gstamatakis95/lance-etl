...
use common::{FakeServingCatalog, build_indexed_dataset, test_admission, test_config, test_target};
use lance::Dataset;
...
async fn serve(
    ...
    let service = SearchGrpc::with_metrics(backend, metrics.clone(), test_admission());

...
def build_runtime_application() -> ReconcilerApplication:
    ...
    engine: Engine = build_control_plane_engine(runtime_settings.database_url)
    ...
    if registered_source is not None:
        ...
        if (
            ...
            raise RuntimeError("LANCE_ETL_CANONICAL_BASELINE_SNAPSHOT_ID differs from the registered PostgreSQL source")
    source_table: str = (
